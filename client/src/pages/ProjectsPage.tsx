...
export function ProjectsPage() {
  ...
  const newInvoiceFor = (projectId: number) =>
    invoices.find(
      (inv) => inv.projectId === projectId && inv.autoGenerated && inv.viewedAt === null
    );
  ...
  return (
    <div>
      ...
      <table className={styles.table}>
        ...
        <tbody>
          {sorted.map((p) => {
            const newInvoice = newInvoiceFor(p.id);
            return (
              <tr
                key={p.id}
